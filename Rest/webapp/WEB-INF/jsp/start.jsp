				...
				<div class="grid-item grid-item-5 grid-opinie-pozytywne">
					...
					<div class="grid-item-content">
						<ul class="opinie opinie-pozytywne">
							<li>
							<p>Zdecydowanie <span>polecam</span> tę firmę, jestem wiernym klientem od wielu lat i są <span>niezawodni</span>! Jak najbardziej <span>polecam</span> jeszcze raz!</p>
							...
							<li>
							<p>Jak najbardziej <span>polecam</span> jeszcze raz! Stanowczo <span>polecam</span> tę markę z Wrocławia ponieważ sam jestem sosnowcowianem i jestem wiernym klientem od wielu lat i są <span>niezawodni</span>!</p>
							<div class="opinia-meta">
								<div class="opinia-zrodlo">
									<span>Źródło:</span> Twitter
								</div>
				...
				<div class="grid-item grid-item-5 last grid-opinie-negatywne">
					...
					<div class="grid-item-content">
						<ul class="opinie opinie-negatywne">
							<li>
							<p>Ta firma jest <span>okropna</span> i stanowczo <span>odradzam</span> jakąkolwiek współpracę z takimi niepoważnymi ludźmi.</p>
							<div class="opinia-meta">
								<div class="opinia-zrodlo">
									<span>Źródło:</span> Twitter
								</div>
							...
							<li>
							<p>Stanowczo <span>odradzam</span> jakąkolwiek współpracę z takimi <span>niepoważnymi</span> ludźmi, ponieważ zostawią Was na lodzie już po tygodniu, a wszystko zostało opłacone <span>oszuści</span> jedni..</p>
							<div class="opinia-meta">
								<div class="opinia-zrodlo">
									<span>Źródło:</span> Twitter
								</div>
